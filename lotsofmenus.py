# Fundamental imports that go at the top of code.
...
menuItem5 = MenuItem(
       ...
       description="A Chinese noodle soup made of stewed or red braised" +
...
menuItem2 = MenuItem(
       ...
       " of minced meat and finely chopped vegetables wrapped into a" +
       " piece of dough skin. The skin can be either thin and" +
       " elastic or thicker.",
       price="$6.99",
       course="Appetizer",
       restaurant=restaurant1)
...
menuItem3 = MenuItem(
       user_id=1,
       name="Gyoza",
       description="light seasoning of Japanese gyoza with salt and" +
...
menuItem4 = MenuItem(
       ...
       description="Golden fried cauliflower florets in a midly spiced" +
       " soya,garlic sauce cooked with fresh cilantro, celery, chilies," +
       " ginger & green onions",
       price="$6.95",
       course="Appetizer",
       restaurant=restaurant1)
...
menuItem5 = MenuItem(
       ...
       description="Vegan goodness. Burrito filled with rice, garbanzo" +
       " beans, curry sauce, potatoes (aloo), fried cauliflower (gobi)" +
       " and chutney. Nom Nom",
       price="$7.95",
       course="Entree",
       restaurant=restaurant1)
...
menuItem1 = MenuItem(
       ...
       description="Lobster, shrimp, sea snails, crawfish, stacked" +
...
menuItem5 = MenuItem(
       user_id=1,
       name="Tonkatsu Ramen",
       description="Noodles in a delicious pork-based broth with" +
       " a soft-boiled egg",
       price="$7.95",
       course="Entree",
       restaurant=restaurant1)
...
menuItem2 = MenuItem(
       user_id=1,
       name="Broiled salmon",
       description="Salmon fillet marinated with fresh herbs and" +
       " broiled hot & fast",
       price="$10.95",
       course="Entree",
       restaurant=restaurant1)
...
menuItem4 = MenuItem(
       ...
       " a spicy mix(chilli, tamarind among others) and slow cooked" +
       " in a cylindrical clay or metal oven which gets its heat" +
...
menuItem1 = MenuItem(
       ...
       " Avocado, Cilantro, Salsa, Tortilla", price="$5.95",
       course="Entree",
       restaurant=restaurant1)
...
# A print statement explaining that the menu items were added to the database.
